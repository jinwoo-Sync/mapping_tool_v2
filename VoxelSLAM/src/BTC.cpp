/**
 * @file BTC.cpp
 * @brief Implementation of Binary Tree Closure descriptor algorithms
 * 
 * Contains the implementation of BTC-based loop closure detection,
 * geometric feature extraction, and binary descriptor generation
 * for efficient place recognition in VoxelSLAM.
 */

#include "BTC.h"

/**
 * @brief Reads configuration parameters for BTC algorithm
 * @param nh ROS node handle for parameter access
 * @param config_setting Configuration structure to populate
 * @param isHighFly Flag indicating high altitude flight mode
 */
