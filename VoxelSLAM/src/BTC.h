/**
 * @file BTC.h
 * @brief Binary Tree Closure (BTC) descriptor for loop closure detection
 * 
 * Implements BTC-based loop closure detection algorithm using binary
 * descriptors extracted from point cloud geometric features. Provides
 * efficient place recognition and loop closure verification.
 */
